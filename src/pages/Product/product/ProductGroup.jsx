...
//       const matchesSearchAll = group.name.toLowerCase().includes(searchAll.toLowerCase());
//       const matchesClientGroup = searchClientGroup ? group.name.toLowerCase().includes(searchClientGroup.toLowerCase()) : true;
...
//         group.id === editGroupId ? { ...group, name: newGroupName } : group
//       ));
//     } else {
//       // Add a new group
//       setGroups([
//         ...groups,
//         { id: groups.length + 1, name: newGroupName, createdAt: new Date().toISOString().split('T')[0] },
//       ]);
//     }
